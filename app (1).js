// ── TMDB CONFIG ───────────────────────────────────────────────────────────────
const TMDB_KEY = "395e4ab1a20e234ecb9c4d2a5c1b4b61"; // free public demo key
const TMDB_IMG = "https://image.tmdb.org/t/p/w500";
const TMDB_BIG = "https://image.tmdb.org/t/p/w1280";

// TMDB IDs for each movie/series
const TMDB_IDS = {
  1:  {id:693134, type:"movie"},   // Dune Part Two
  2:  {id:872585, type:"movie"},   // Oppenheimer
  3:  {id:496243, type:"movie"},   // Parasite
  4:  {id:545611, type:"movie"},   // Everything Everywhere
  5:  {id:414906, type:"movie"},   // The Batman
  6:  {id:361743, type:"movie"},   // Top Gun Maverick
  13: {id:157336, type:"movie"},   // Interstellar
  14: {id:27205,  type:"movie"},   // Inception
  15: {id:419430, type:"movie"},   // Get Out
  16: {id:120467, type:"movie"},   // Grand Budapest Hotel
  17: {id:546554, type:"movie"},   // Knives Out
  18: {id:700391, type:"movie"},   // Minari
  19: {id:447332, type:"movie"},   // A Quiet Place
  20: {id:244786, type:"movie"},   // Whiplash
  21: {id:278,    type:"movie"},   // Shawshank
  22: {id:155,    type:"movie"},   // Dark Knight
  23: {id:129,    type:"movie"},   // Spirited Away
  24: {id:313369, type:"movie"},   // La La Land
  25: {id:299534, type:"movie"},   // Avengers Endgame
  26: {id:475557, type:"movie"},   // Joker
  27: {id:284054, type:"movie"},   // Black Panther
  28: {id:634649, type:"movie"},   // Spider-Man No Way Home
  29: {id:493922, type:"movie"},   // Hereditary
  30: {id:530915, type:"movie"},   // 1917
  7:  {id:1396,   type:"tv"},      // Breaking Bad
  8:  {id:66732,  type:"tv"},      // Stranger Things
  9:  {id:100088, type:"tv"},      // The Last of Us
  10: {id:119051, type:"tv"},      // Wednesday
  11: {id:94997,  type:"tv"},      // House of the Dragon
  12: {id:97546,  type:"tv"},      // Ted Lasso
  31: {id:1399,   type:"tv"},      // Game of Thrones
  32: {id:65494,  type:"tv"},      // The Crown
  33: {id:71446,  type:"tv"},      // Money Heist
  34: {id:93405,  type:"tv"},      // Squid Game
  35: {id:69740,  type:"tv"},      // Ozark
  36: {id:70523,  type:"tv"},      // Dark
  37: {id:71912,  type:"tv"},      // The Witcher
  38: {id:85552,  type:"tv"},      // Euphoria
  39: {id:60574,  type:"tv"},      // Peaky Blinders
  40: {id:42009,  type:"tv"},      // Black Mirror
  41: {id:79744,  type:"tv"},      // Succession
  42: {id:94605,  type:"tv"},      // Arcane
};
...
async function fetchPoster(movieId) {
  if (posterCache[movieId]) return posterCache[movieId];
  const info = TMDB_IDS[movieId];
  if (!info) return null;
  try {
    const url = `https://api.themoviedb.org/3/${info.type}/${info.id}?api_key=${TMDB_KEY}`;
    const res = await fetch(url);
    const data = await res.json();
    const poster    = data.poster_path    ? TMDB_IMG + data.poster_path    : null;
    const backdrop  = data.backdrop_path  ? TMDB_BIG + data.backdrop_path  : null;
    posterCache[movieId] = { poster, backdrop };
    return posterCache[movieId];
  } catch(e) { return null; }
}

async function loadAllPosters() {
  await Promise.all(MOVIES.map(m => fetchPoster(m.id)));
  render();
}
...
render(); // first render with emoji fallback
loadAllPosters(); // fetch real posters, re-render when done
